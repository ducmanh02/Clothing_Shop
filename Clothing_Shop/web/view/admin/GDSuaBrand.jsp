        ...
        <jsp:include page="../components/NavbarAdmin.jsp" ></jsp:include>
            <div class="container ">
                ...
                <div class="container d-flex justify-content-center ">
                    ...
                    <form class="boxForm w-50 " action="qlbrand?action=update&brand_id=${b.brand_id}" method="post">
                    <h1 class="text-center p-3">Update Brand</h1>

                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" placeholder="brand name" name="brand_name" value="${b.brand_name}" required>
